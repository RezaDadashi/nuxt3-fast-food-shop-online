                            ...
                            <div class="col-md-7 col-lg-6">
                                <div class="detail-box">
                                    <h2 class="mb-3 fw-bold">
                                        سفارش آنلاین با بهترین کیفیت
                                    </h2>
                                    <p>
                                      وقتی می‌توانیم در یک چشم به‌هم‌زدن غذای موردعلاقه‌‌مان را با بهترین کیفیت در محل دلخواه دریافت کنیم
                                      <br>
                                       دیگر چرا خرید حضوری؟
                                    </p>
                                    <div class="btn-box">
                                        <nuxtLink to="/menu" class="btn1">
                                            شروع کنید
                                        </nuxtLink>
                                    </div>
                                </div>
